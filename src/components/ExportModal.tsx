        ...
        <>
          ...
          <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 pointer-events-none">
            <motion.div
              ...
              className="bg-slate-900 border border-white/10 shadow-2xl rounded-2xl w-full max-w-lg pointer-events-auto overflow-hidden flex flex-col"
            >
              {/* Header */}
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-slate-950/50 border border-white/5 rounded-xl p-5 space-y-4">
              ...
              <div className="p-6 pt-0 flex gap-3">
                <button 
                  onClick={onClose}
                  className="flex-1 py-3 px-4 rounded-xl font-bold text-sm text-slate-300 bg-slate-800 hover:bg-slate-700 transition-all"
                >
                  Cancel
                </button>
                <button 
                  ...
                  className="flex-[2] py-3 px-4 rounded-xl font-bold text-sm text-white bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 shadow-lg shadow-cyan-500/20 transition-all flex items-center justify-center gap-2"
                >
